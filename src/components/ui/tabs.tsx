...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-xl p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-white/90 backdrop-blur-md border border-slate-200/60 dark:bg-[#131527]/90 dark:border-slate-800/60",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:bg-gradient-to-r data-active:from-[#7B61FF] data-active:to-[#FF5C00] data-active:text-white dark:data-active:text-white",
