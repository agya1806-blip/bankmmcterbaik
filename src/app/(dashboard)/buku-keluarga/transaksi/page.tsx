  ...
  return (
    <div className="max-w-2xl mx-auto pb-20 space-y-4 animate-fade-in">
      <div className="flex items-center gap-3">
        <button onClick={() => router.push("/buku-keluarga")} className="btn-ghost size-10 rounded-xl flex items-center justify-center">
        ...
        {filtered.map((t) => {
          ...
          return (
            <div key={t.id} className="premium-card bg-white/90 backdrop-blur-md dark:bg-[#131527]/90 border border-slate-200/60 dark:border-slate-800/60 p-3 flex items-center gap-3">
              <div className={`size-9 rounded-xl premium-card bg-white/90 backdrop-blur-md dark:bg-[#131527]/90 border border-slate-200/60 dark:border-slate-800/60 flex items-center justify-center ${warna}`}>
