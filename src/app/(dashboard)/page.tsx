...
const MAIN_BOOKS: BookCard[] = [
  ...
  { slug: "usaha", label: "Buku Usaha", desc: "Unit usaha & bisnis", icon: <Building2 className="w-5 h-5 text-white" />, color: "from-amber-400 to-orange-500", route: "/buku-bisnis" },
];
...
export default function DashboardUtamaPage() {
  ...
  const quickActions = useMemo(() => [
    { label: "Transaksi Baru", icon: <ShoppingCart className="w-5 h-5" />, color: "from-blue-500 to-blue-600", onClick: () => router.push("/buku-bisnis") },
    { label: "Produk Baru", icon: <Package className="w-5 h-5" />, color: "from-emerald-500 to-emerald-600", onClick: () => router.push("/buku-bisnis") },
    { label: "Pelanggan Baru", icon: <Users className="w-5 h-5" />, color: "from-violet-500 to-violet-600", onClick: () => router.push("/buku-bisnis") },
    { label: "Cashflow", icon: <Wallet className="w-5 h-5" />, color: "from-cyan-500 to-cyan-600", onClick: () => router.push("/buku-bisnis") },
    { label: "Transfer", icon: <ArrowRightLeft className="w-5 h-5" />, color: "from-rose-500 to-rose-600", onClick: () => router.push("/") },
    ...
    { label: "Produksi Baru", icon: <Layers className="w-5 h-5" />, color: "from-purple-500 to-purple-600", onClick: () => router.push("/buku-bisnis") },
    { label: "Laporan", icon: <FileText className="w-5 h-5" />, color: "from-rose-500 to-rose-600", onClick: () => router.push("/buku-bisnis") },
  ], [router]);
  ...
  const shortcutModules = useMemo(() => [
    ...
    { label: "Buku Usaha", icon: <Building2 className="w-5 h-5" />, color: "from-amber-400 to-orange-500", desc: "Unit usaha & bisnis", path: "/buku-bisnis" },
    { label: "Kasir", icon: <BanknoteIcon className="w-5 h-5" />, color: "from-blue-500 to-blue-600", desc: "Proses transaksi penjualan", path: "/buku-bisnis" },
    { label: "Inventory", icon: <Package className="w-5 h-5" />, color: "from-emerald-500 to-emerald-600", desc: "Manajemen stok barang", path: "/buku-bisnis" },
    { label: "Laporan", icon: <FileText className="w-5 h-5" />, color: "from-cyan-500 to-cyan-600", desc: "Laporan penjualan", path: "/buku-bisnis" },
    { label: "Pengaturan", icon: <Settings className="w-5 h-5" />, color: "from-slate-500 to-slate-600", desc: "Pengaturan & backup", path: "/" },
  ], [router]);
  ...
  if (!currentUser) {
    return (
      <div className="flex-1 flex items-center justify-center min-h-screen bg-[#F5F9FC] dark:bg-[#0A1628]">
  ...
  return (
    <div className="flex-1 flex flex-col gap-5 pt-2 pb-8 animate-fade-in">
      ...
      {/* ───── 5. RECENT ACTIVITY ───── */}
      <SectionHeader title="Transaksi Terbaru" onSeeAll={() => router.push("/")} />
      <Card>
        <CardContent>
          {recentTx.length === 0 ? (
