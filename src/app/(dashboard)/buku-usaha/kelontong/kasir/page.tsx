...
import { ShoppingBag, Plus, Minus, Trash2, ArrowLeft, CheckCircle2, Package } from "lucide-react";
      ...
      {!showBill ? (
        <>
          <div className="flex items-center gap-3">
            ...
            <div className="size-11 rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center shadow-xl">
              <ShoppingBag className="size-5 text-white" />
            </div>
            <div>
              <h1 className="text-base font-bold font-heading">Kasir Kelontong</h1>
              <p className="text-[10px] text-muted-foreground/60">Toko Kelontong & Sembako</p>
            </div>
          </div>
          ...
          <div className="floating-card p-4 space-y-3">
            ...
            <div className="flex gap-2">
              <input type="text" value={itemNama} onChange={(e) => setItemNama(e.target.value)}
                placeholder="Nama barang" className="input-premium flex-1 text-xs"
