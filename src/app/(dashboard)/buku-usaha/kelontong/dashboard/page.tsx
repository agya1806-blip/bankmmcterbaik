    ...
    <div className="max-w-2xl mx-auto pb-20 space-y-5 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Toko Kelontong & Sembako</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button onClick={() => router.push("/buku-usaha/kelontong/kasir")}
          ...
          <p className="text-[10px] text-slate-500 dark:text-slate-400">Transaksi kelontong</p>
        </button>
        <button
