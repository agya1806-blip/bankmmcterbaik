    ...
    <div className="max-w-2xl mx-auto pb-20 space-y-5 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Toko Gadget & Aksesoris</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="premium-stat">
          ...
          <p className="premium-stat-value text-cyan-500">{gadgetItems.length}</p>
        </div>
        <div className="premium-stat">
          <p className="premium-stat-label">Total Stok</p>
          <p className="premium-stat-value text-cyan-500">{totalStok}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button onClick={() => router.push("/buku-usaha/gadget/kasir")}
          ...
          <p className="text-[10px] text-slate-500 dark:text-slate-400">Transaksi penjualan gadget</p>
        </button>
