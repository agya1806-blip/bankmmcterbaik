    ...
    <div className="max-w-2xl mx-auto pb-20 space-y-5 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground/60">Warkop & Minuman</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button onClick={() => router.push("/buku-usaha/warkop/kasir")}
          ...
          <p className="text-[10px] text-muted-foreground/50">Transaksi warkop</p>
        </button>
        <button
          ...
          <p className="text-[10px] text-muted-foreground/50">Kelola menu & stok</p>
        </button>
      </div>
    </div>
  );
