  ...
  return (
    <div className="flex flex-col h-full max-w-lg mx-auto pt-8 pb-20">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-base font-bold font-heading">Mode Kios Kasir</h1>
          <p className="text-[10px] text-slate-400">Kunci layar ke POS Kasir tertentu</p>
        </div>
      </div>

      {!selectedBranch ? (
        <div>
          <p className="text-xs text-slate-500 mb-3 font-semibold uppercase tracking-wider">Pilih Cabang</p>
        ...
        <div className="space-y-5">
          <div className="rounded-2xl bg-slate-900/80 border border-slate-800/60 p-4 text-center space-y-3">
            <p className="text-xs text-slate-500">Masukkan PIN untuk membuka kunci</p>
            ...
            <p className="text-sm font-bold font-heading">{BRANCHES.find((b) => b.slug === selectedBranch)?.label}</p>
            <input
              type="password"
              inputMode="numeric"
              maxLength={6}
              ...
              className={`input-premium w-full text-center text-sm tabular-nums bg-slate-900/80 ${pinError ? "border-rose-500" : ""}`}
              autoFocus
            />
            {pinError && (
          ...
          <div className="rounded-2xl bg-slate-900/80 border border-slate-800/60 p-4 space-y-2">
            <p className="text-[10px] font-semibold text-slate-400">Tentang Mode Kios</p>
